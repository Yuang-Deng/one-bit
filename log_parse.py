...
tapl = []
for i in iter:
    writer.add_scalar('stu/mAP', float(stuap[i]['AP']  ), global_step=i)
    writer.add_scalar('stu/AP50',float(stuap[i]['AP50']), i)
    writer.add_scalar('stu/AP75',float(stuap[i]['AP75']), i)
    writer.add_scalar('stu/APs', float(stuap[i]['APs'] ), i)
    writer.add_scalar('stu/APm', float(stuap[i]['APm'] ), i)
    writer.add_scalar('stu/APl', float(stuap[i]['APl'] ), i)
    writer.add_scalar('teacher/mAP', float(stuap[i]['AP']  ), i)
    writer.add_scalar('teacher/AP50',float(stuap[i]['AP50']), i)
    writer.add_scalar('teacher/AP75',float(stuap[i]['AP75']), i)
    writer.add_scalar('teacher/APs', float(stuap[i]['APs'] ), i)
    writer.add_scalar('teacher/APm', float(stuap[i]['APm'] ), i)
    writer.add_scalar('teacher/APl', float(stuap[i]['APl'] ), i)
