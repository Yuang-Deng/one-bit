...
def main():
    ...
    labeled_idxs_stage1 = np.load('./index_' + ds + '/rand_select/pred_true_stage1.npy')
    ...
    pred_true, pred_false, false_pred = one_bit_super_stage2(top1_pred_list, traget_list, idx_list, num_query=num_query)
    #print(len(pred_true), len(pred_false), len(false_pred))

    #pdb.set_trace()
    os.makedirs('./index_' + ds + '/rand_select', exist_ok=True)

    np.save('./index_' + ds + '/rand_select/pred_true_stage2.npy', pred_true)
    np.save('./index_' + ds + '/rand_select/pred_false_stage2.npy', pred_false)
    np.save('./index_' + ds + '/rand_select/false_pred_stage2.npy', false_pred)
