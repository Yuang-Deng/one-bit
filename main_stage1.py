...
from main_stage0 import CIFAR10DS, CIFAR100DS
...
import one_bit_annotation_stage1
...
def create_data_loaders(train_transformation,
    ...
    labeled_idxs, unlabeled_idxs = data.relabel_dataset_stage1(dataset, labeled_idxs, false_pred_dict1)
    ...
    test_loader = torch.utils.data.DataLoader(
        CIFAR100DS(testdir, train=True, transform=eval_transformation),
        batch_size=200,
        shuffle=False,
...
def save_checkpoint(state, is_best, dirpath, epoch):
    ...
    checkpoint_path = os.path.join(dirpath, 'stage1', filename)
    best_path = os.path.join(dirpath, 'stage1', 'best_stage1.ckpt')
